...
# Experiment: Pop (Popularity) Temporal Stability - 36h training windows
# ID: exp_pop_temporal_36h
# Description: Evaluate popularity baseline stability across temporal windows in news recommendation
# Date: 2025-12-06
# Configuration:
#   - Model: Pop
...
EXPERIMENT_ID="exp_pop_temporal_36h"
DESCRIPTION="Pop (popularity) temporal stability with 36h train, 12h test, 12h stride across 144h MIND dataset"
MODEL="Pop"
DATASET="mind_small"
