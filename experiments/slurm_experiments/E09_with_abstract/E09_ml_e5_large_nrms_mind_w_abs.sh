...
export EXPERIMENT_ID="E09_ml_e5_large_nrms_mind_w_abs"
MODEL="NRMS_mlE5_L_abs"
DATASET="mind"
...
python run_slurm_experiment.py create \
    ...
    --time-limit "24:00:00" \
    --memory "32G" \
    --description "E09 NRMS on MIND, using intfloat's multilingual E5 Large instruct to encode news content with abstract" \
