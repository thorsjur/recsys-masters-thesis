...
# Experiment: TFIDF Temporal Stability - 36h training windows
# ID: exp_tfidf_temporal_36h
# Description: Evaluate TFIDF baseline stability across temporal windows in news recommendation
# Date: 2025-12-06
# Configuration:
#   - Model: TFIDF
...
EXPERIMENT_ID="exp_tfidf_temporal_36h"
DESCRIPTION="TFIDF temporal stability with 36h train, 12h test, 12h stride across 144h MIND dataset"
MODEL="TFIDF"
DATASET="mind_small"
